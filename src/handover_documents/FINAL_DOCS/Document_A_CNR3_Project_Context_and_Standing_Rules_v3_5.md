...
**Version:** Document A v3.5 — RESUME-state regeneration generated from Production Spec **v2.11**
populated §3.2 (canonical context, reproduced verbatim) and §3A (Prevailing Rules Register, reproduced
in full). **v3.5 change over v3.4:** (a) adds the **CNR3 Design Alignment and Escalation Charter** as
...
maintainer.
**Generation source:** `CNR3_Handover_Pack_Production_Spec_v2_11.md`  
...
**branch-(d) recovery arc is now COMPLETE** — committed through phase **CMS07-D.5** at
**52/52 selftests** (forced-fail 51/52 exit 1). The live getFrame dispatch is feature-complete
...
fmParallel validation phase. **Next phase: P.11C scene-change uniform wiring across branch-a/c/d**
