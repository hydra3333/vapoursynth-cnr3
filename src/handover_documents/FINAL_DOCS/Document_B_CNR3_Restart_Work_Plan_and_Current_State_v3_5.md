# Document B — CNR3 Work Plan and Current Build State (CMS07.10, RESUME)

**Version:** Document B v3.5 (state advanced K.1E.3 -> K.1F). v3.4 was a version bump over the v3.2.9.x generation.  
