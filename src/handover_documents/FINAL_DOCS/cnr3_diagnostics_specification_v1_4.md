# CNR3 Diagnostics Specification v1.4

**Status:** Draft v1.4 for review and iteration, separate numbering convention to CMS
**Date:** 2026-06-17  
...
[ ] For any D-SUM diagnostic compute gate introduced or changed by the phase, the
    exit evidence satisfies Production Spec §3A R-PROCESS-19
    (D-SUM compute-disabled observe-only proof).
