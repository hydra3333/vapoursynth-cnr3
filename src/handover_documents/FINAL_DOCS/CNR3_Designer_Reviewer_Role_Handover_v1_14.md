...
Last committed marker:      CMS07-P.11C.5-scene-cut-checkpoint-recovery-anchor-proof (then W.1 -- confirm repo)
...
ACTIVE ARC:                 LIVE CACHE-PRESSURE WIRING (W.1 -> W.2 -> W.3), single-activation scope. STEP 0
                            ...
                            W.3 = combined live store-and-prune helper (§7.5 six-step order; wires §7.2 + §7.4
                                  into the live path; temporary KDT). THEN real-footage -> diagnostics -> fmParallel.
