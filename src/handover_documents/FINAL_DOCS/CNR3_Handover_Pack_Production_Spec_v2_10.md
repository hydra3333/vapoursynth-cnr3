...
Currency refresh: the current controlling CMS is **CMS07.10** (`cnr3_cache_manager_design_v7_10.md`);
...
**CMS07.0 or its later approved successor** (currently **CMS07.10**). EXCEPT:
...
`cnr3_cache_manager_design_v7_0.md`, or the current `cnr3_cache_manager_design_v7_10.md`)
...
cnr3_cache_manager_design_v7_10.md
    The current CMS (CMS07.10) — included UNCHANGED as the controlling design authority.
...
The current CMS (`cnr3_cache_manager_design_v7_10.md`, CMS07.10) is included UNCHANGED as the
...
[ ] The current CMS included unchanged (currently cnr3_cache_manager_design_v7_10.md).
