...
**Date:** 2026-06-19
**Version:** v2.6
**Supersedes:** Production Spec v2.5. Production Spec v2.5 superseded v2.4; v2.4 superseded
v2.3; v2.3 superseded Production Spec v1.5, which governed continuity through the CMS06.x
proof phases. v2.6 continues the **CMS07.0 restart** production-spec line: a clean
architectural supersession, not a continuation. The governing purpose changed at v2.3, so
this remains a new version line rather than an in-place edit of v1.5.
**v2.6 change (additive, clarification only):** clarifies within R-PROCESS-20 that the
coder's "isolated selftest build: PASS" is the coder's sandbox-local isolated compile and
is NOT a substitute for the coordinator's authoritative VS2026 Debug/Release builds. No
rule is added or removed; no behaviour changes; the canonical context (§3.2) and all rules
are otherwise unchanged. (v2.4 added R-PROCESS-19; v2.5 added R-PROCESS-20; v2.6 clarifies
R-PROCESS-20.) **Note on Document A lag:** the most recently generated Document A is v3.2,
which predates R-PROCESS-20; per R-PACK-02, on any Document A / §3A mismatch §3A (this
spec) is authoritative, so §3A is the controlling source for R-PROCESS-20 until Document A
is next regenerated.
...
CNR3_Handover_Pack_Production_Spec_v2.4.md
...
the restart (this spec is v2.4; the pack manifest version is the producer's choice,
...
[ ] This Production Spec v2.4 included.
