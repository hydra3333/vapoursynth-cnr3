...
Marshalling arc status:    0A -28% | 0B flat | 3a.1 -37% | 3b.1 flat | 3a.2 flat (vectorised C5001 but leaf is MEMORY-bound). cumulative ~-55% (93,914 -> ~41,850). KEY FINDING: residual marshalling is MEMORY-bound -> next lever = ELIMINATE the int buffer (native->native/buffer-free/fusion), NOT more SIMD. 3c (blend) + buffer-free direction ahead. 3b.2 likely moot (also memory-bound).
