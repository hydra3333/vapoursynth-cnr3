...
Controlling:    CMS07.13 (UNCHANGED; additive P.11C implementation note only) / companion v7.13 /
                Production Spec v2.12 / Document A v3.5 / diagnostics v1.5.
...
Doc set:        Production Spec v2.12, Document A v3.5, this Document B v3.6, CMS v7.13 (additive note),
                Role Handover v1.11, Reviewer Intro v3.4, Coder Restart Intro v6.2, Future Investigations
                v7.13, Diagnostics Condensed Plan v1.1. The live per-phase ledger is the current DELTA
