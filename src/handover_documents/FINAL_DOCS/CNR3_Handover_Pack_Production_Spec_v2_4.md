...
**Date:** 2026-06-17
**Version:** v2.4
**Supersedes:** Production Spec v2.3. Production Spec v2.3 superseded Production Spec
v1.5, which governed continuity through the CMS06.x proof phases. v2.4 continues the
**CMS07.0 restart** production-spec line: a clean architectural supersession, not a
continuation. The governing purpose changed at v2.3, so this remains a new version line
rather than an in-place edit of v1.5.
