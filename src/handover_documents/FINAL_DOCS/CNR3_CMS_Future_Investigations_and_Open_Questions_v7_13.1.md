...
FI-09  Live prune-TRIGGER contract for SINGLE-ACTIVATION wiring (NEW, 2026-06-28) - the prune PASS
       ...
       of the live cache-pressure wiring phase (the immediate next phase).
```
