...
**Supersedes:** CMS06.5 supersedes CMS06.4, CMS06.3, CMS06.2, CMS06.1, CMS06, CMS05.2b, CMS05.2, CMS05.1, CMS05, CMS04, CMS03, CMS02, CMS01
...
#### CMS02-H / SubPhase H5+ / bounded-warm-up-source-and-compute
**Status: Not started. Requires H4 proven.**
...
- Use H4's proven source-frame-set acquisition pattern for source frames.
...
The review must verify that the resulting execution paths follow CMS06.5,
