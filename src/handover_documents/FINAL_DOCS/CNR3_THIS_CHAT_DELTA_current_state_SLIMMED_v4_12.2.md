...
```text
Committed/pushed through:  CMS07-P.11C.4-branch-d-recovery-scene-detection-enable (P.11C in progress; branch-c+d PROVEN)
...
## 4. ACTIVE / NEXT PHASE — P.11C scene-change uniform wiring (NOT a recovery phase)
