...
**Version:** v4.3 (DELTA through K.1G + CMS07.10; CMS07.10 commit-status reconciled)
**Date:** 2026-06-26
...
**Sequencing:** (1) VERIFY the corrected CMS07.10 is committed (§1 status note — it was committed in the producing session; confirm, and only re-commit if the repo somehow holds the pre-fix version). (2) Then D.1.
