...
**Date:** 2026-06-17 (CMS07.2; supersedes CMS07.1 dated 2026-06-17, which superseded CMS07.0 dated 2026-06-12)
**Version:** CMS07.2
...
CMS07.2 is an ADDITIVE change over CMS07.1: it adds the companion-document front-matter
note immediately below; no design rule, decision, constant, or section number is
changed or removed (see §14 changelog). CMS07.1 itself added §6.6 (checkpoint flag is
monotonic under duplicate stores) and a §9.3 cross-reference over CMS07.0.
