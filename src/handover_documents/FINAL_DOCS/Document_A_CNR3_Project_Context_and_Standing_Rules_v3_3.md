...
**Version:** v3.3 (CMS07.0 restart line; generated from Production Spec v2.7 populated §3A)  
**Date:** 2026-06-23  
...
maintainer.
**Generation source:** `CNR3_Handover_Pack_Production_Spec_v2_7.md`  
...
The Production Spec is now **v2.7**, which added register rules **R-PROCESS-20** (the Patch
