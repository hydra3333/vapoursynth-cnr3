...
**Date:** 2026-06-19 (CMS07.3; supersedes CMS07.2 dated 2026-06-17, which superseded CMS07.1 dated 2026-06-17, which superseded CMS07.0 dated 2026-06-12)
**Version:** CMS07.3
...
CMS07.3 is an ADDITIVE clarification over CMS07.2: it adds §9.6 (current minimal
recovery path, AS3 deferral, the two state categories, and the developer-alert
principle) and a STATUS NOTE on the AS3 register entry in §8.7; no design rule,
decision, constant, or section number is changed or removed (see §14 changelog).
...
`_v7.2.md`). It records deferred design questions and open tuning investigations. It is
