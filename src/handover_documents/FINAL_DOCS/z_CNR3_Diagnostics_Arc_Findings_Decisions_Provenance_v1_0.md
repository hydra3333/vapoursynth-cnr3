...
arc (which is sequenced AFTER P.11C). It is NOT a scope and NOT a CMS change — the diagnostics DESIGN is
...
**Branch:** dev_cache_manager. Baseline: committed through D.5, 52/52.
