...
NEXT — downstream of the now-proven cache core, continuing the pixel arc:
    ...
    4. Visual Studio 2026 project wiring for the full plugin build.

    NOTE on the arc shift: the pixel/integration phases leave the isolated cache-core selftest
    harness and move into pixel maths and live VapourSynth interaction. The PDAP delivery
