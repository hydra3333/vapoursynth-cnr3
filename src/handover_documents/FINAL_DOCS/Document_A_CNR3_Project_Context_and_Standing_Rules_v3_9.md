...
**Version:** Document A v3.9 — RESUME-state regeneration generated from Production Spec **v2.14**
populated §3.2 (canonical context, reproduced verbatim) and §3A (Prevailing Rules Register, reproduced
in full). **v3.9 change over v3.8 (currency touch only; NO register-owned rule text changed):** (a) advances the
