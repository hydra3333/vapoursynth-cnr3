...
**Version:** v1.7 (versioned in lockstep with the P.11C scope at coordinator request. History: v1.0 first coder round; v1.1 second-round review + threshold resolution §7A; v1.2 §7B arithmetic/colourspace verification + RESOLVED depth-scaling accuracy decision; v1.6 lockstep bump + post-D.5 source confirmed; v1.7 folds in the coder's two wording fixes -- fractional base8 / floating round_to_nearest form, and the 8-bit non-identity (round vs truncate, <=1 unit) -- plus the existing-goldens-unaffected finding)
**Date:** 2026-06-27
...
*End of CNR3 P.11C Coder Read-First Outcome v1.7.*
