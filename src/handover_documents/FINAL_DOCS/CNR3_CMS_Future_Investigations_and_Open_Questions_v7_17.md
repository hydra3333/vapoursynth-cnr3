...
**Version:** v7.17 (supersedes v7.16). Adds FI-11 (recovery-path re-churn), FI-12 (global/primitive ref balance), FI-13 (production-duplicate checkpoint-promotion signal) — all raised during the DIAGNOSTICS ARC (DIAG.2a finding + DIAG.2b coder inventory review). No change to FI-01..FI-10.
