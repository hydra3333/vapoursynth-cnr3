...
**Date:** 2026-06-17 (CMS07.1; supersedes CMS07.0 dated 2026-06-12)
**Version:** CMS07.1
...
CMS07.1 is an ADDITIVE clarification of CMS07.0: it adds §6.6 (checkpoint flag is
monotonic under duplicate stores) and a cross-reference in §9.3; no existing rule,
decision, or section number is changed or removed (see §14 changelog).
