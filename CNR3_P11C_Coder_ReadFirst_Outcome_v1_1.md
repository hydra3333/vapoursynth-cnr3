...
**Version:** v1.1 (v1.0 = first coder round; v1.1 adds the second-round review + threshold resolution, §7A)
**Date:** 2026-06-27
...
against vsCnr2.cpp (Role Handover), and consistent with the detector's accumulation units:
    ...
    max_pixel_diff = scene_chroma ? ((219 + 224*2) >> (subw+subh)) : 219    (w,h = chroma grid)
...
*End of CNR3 P.11C Coder Read-First Outcome v1.1.*
